...
class MainWindow():
    ...
    def __init__(self):
        ...
        self.builder.add_from_file("main2.ui")
        ...
        for program in sql_programs:
            self.button = ButtonGen(program[:2], program[2:4])
...
class SettingsWindow(Gtk.Window):
    ...
    def error_alert(self, widget):
        self.alert = Gtk.MessageDialog(self, 0, Gtk.MessageType.ERROR, Gtk.ButtonsType.CANCEL, "Cannot apply changes without the", widget, "field being populated.")
        self.alert.run()
        self.alert.destroy()
    ...
    def __init__(self):
        ...
        self.builder = Gtk.Builder()
        self.builder.add_from_file("settings3.ui")
...
for record in c.execute("""
            SELECT Programs.ProgramName, Programs.PreferredProgramName, ProgramCommands.ProgramCMD, Programs.PreferredCommand, Programs.DisplayProgram
